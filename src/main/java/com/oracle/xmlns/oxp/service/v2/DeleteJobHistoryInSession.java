 ...
 *       &lt;sequence>
 *         &lt;element name="instanceJobID" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "deleteJobHistoryInSession")
public class DeleteJobHistoryInSession {

    @XmlElement(required = true)
    protected String instanceJobID;
    @XmlElement(required = true)
    protected String bipSessionToken;

    /**
     * Gets the value of the instanceJobID property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the instanceJobID property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setInstanceJobID(String value) {
        this.instanceJobID = value;
    }
