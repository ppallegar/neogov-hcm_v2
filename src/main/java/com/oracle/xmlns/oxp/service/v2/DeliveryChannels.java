 ...
 *       &lt;sequence>
 *         &lt;element name="emailOptions" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfEMailDeliveryOption"/>
 *         &lt;element name="faxOptions" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfFaxDeliveryOption"/>
 *         &lt;element name="ftpOptions" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfFTPDeliveryOption"/>
 *         &lt;element name="localOptions" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfLocalDeliveryOption"/>
 *         &lt;element name="printOptions" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfPrintDeliveryOption"/>
 *         &lt;element name="wccOptions" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfWCCDeliveryOption"/>
 *         &lt;element name="webDAVOptions" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfWebDAVDeliveryOption"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DeliveryChannels {
    ...
    @XmlElement(required = true, nillable = true)
    protected ArrayOfWCCDeliveryOption wccOptions;
    @XmlElement(required = true, nillable = true)
    ...
    /**
     * Gets the value of the wccOptions property.
     * 
     * @return
     *     possible object is
     *     {@link ArrayOfWCCDeliveryOption }
     *     
     */
    public ArrayOfWCCDeliveryOption getWccOptions() {
        return wccOptions;
    }

    /**
     * Sets the value of the wccOptions property.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfWCCDeliveryOption }
     *     
     */
    public void setWccOptions(ArrayOfWCCDeliveryOption value) {
        this.wccOptions = value;
    }
