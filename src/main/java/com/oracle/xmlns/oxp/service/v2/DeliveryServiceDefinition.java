 ...
 *       &lt;sequence>
 *         &lt;element name="EMailServerNames" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfString"/>
 *         &lt;element name="FTPServerNames" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfString"/>
 *         &lt;element name="HTTPServerNames" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfString"/>
 *         &lt;element name="SFTPServerNames" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfString"/>
 *         &lt;element name="defaultServerNames" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfString"/>
 *         &lt;element name="faxServerNames" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfString"/>
 *         &lt;element name="printerNames" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfString"/>
 *         &lt;element name="webDAVServerNames" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfString"/>
 *         &lt;element name="wccServerNames" type="{http://xmlns.oracle.com/oxp/service/v2}ArrayOfString"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DeliveryServiceDefinition {
    ...
    @XmlElement(required = true, nillable = true)
    protected ArrayOfString wccServerNames;
    ...
    /**
     * Gets the value of the wccServerNames property.
     * 
     * @return
     *     possible object is
     *     {@link ArrayOfString }
     *     
     */
    public ArrayOfString getWccServerNames() {
        return wccServerNames;
    }

    /**
     * Sets the value of the wccServerNames property.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfString }
     *     
     */
    public void setWccServerNames(ArrayOfString value) {
        this.wccServerNames = value;
    }
