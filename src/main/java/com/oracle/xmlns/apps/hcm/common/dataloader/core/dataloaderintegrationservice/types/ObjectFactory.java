 ...
 * generated in the com.oracle.xmlns.apps.hcm.common.dataloader.core.dataloaderintegrationservice.types package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.oracle.xmlns.apps.hcm.common.dataloader.core.dataloaderintegrationservice.types
     * 
     */
    ...
    /**
     * Create an instance of {@link GetDataSetStatusAsync }
     * 
     */
    public GetDataSetStatusAsync createGetDataSetStatusAsync() {
        return new GetDataSetStatusAsync();
    }

    /**
     * Create an instance of {@link ImportAndLoadDataAsync }
     * 
     */
    public ImportAndLoadDataAsync createImportAndLoadDataAsync() {
        return new ImportAndLoadDataAsync();
    }

    /**
     * Create an instance of {@link GetDataSetStatusAsyncResponse }
     * 
     */
    public GetDataSetStatusAsyncResponse createGetDataSetStatusAsyncResponse() {
        return new GetDataSetStatusAsyncResponse();
    }

    /**
     * Create an instance of {@link GetDataSetStatusResponse }
     * 
     */
    public GetDataSetStatusResponse createGetDataSetStatusResponse() {
        return new GetDataSetStatusResponse();
    }

    /**
     * Create an instance of {@link GetDataSetStatus }
     * 
     */
    public GetDataSetStatus createGetDataSetStatus() {
        return new GetDataSetStatus();
    }
    ...
    /**
     * Create an instance of {@link ImportAndLoadDataResponse }
     * 
     */
    public ImportAndLoadDataResponse createImportAndLoadDataResponse() {
        return new ImportAndLoadDataResponse();
    }
    ...
    /**
     * Create an instance of {@link ImportAndLoadData }
     * 
     */
    public ImportAndLoadData createImportAndLoadData() {
        return new ImportAndLoadData();
    }

    /**
     * Create an instance of {@link ImportAndLoadDataAsyncResponse }
     * 
     */
    public ImportAndLoadDataAsyncResponse createImportAndLoadDataAsyncResponse() {
        return new ImportAndLoadDataAsyncResponse();
    }
